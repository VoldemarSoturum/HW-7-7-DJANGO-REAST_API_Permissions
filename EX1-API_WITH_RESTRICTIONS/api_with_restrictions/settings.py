...
ALLOWED_HOSTS = ['localhost', '127.0.0.1'] # ---FOR HTTPS
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'django_extensions',  # <-- FOR HTTPS URL`s
...
# ЧТОБЫ НЕ БЫЛО ВОЗМОЖНОСТИ ТРОТЛИТЬ!!!
    'DEFAULT_THROTTLE_CLASSES': [
        'rest_framework.throttling.AnonRateThrottle',
        'rest_framework.throttling.UserRateThrottle',
    ],
    'DEFAULT_THROTTLE_RATES': {
        'anon': '10/min',   # неавторизованные — 10 в минуту
        'user': '20/min',   # авторизованные — 20 в минуту
    },
}
